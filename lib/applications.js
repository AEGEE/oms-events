...
exports.createApplication = async (req, res) => {
    ...
    await sequelize.transaction(async (t) => {
        ...
        newApplication.notification_email = await core.fetchUser(req.body, req.headers['x-auth-token']);

        // Sending the mail to a user.
        await mailer.sendMail({
            to: newApplication.notification_email,
...
exports.updateApplication = async (req, res) => {
    ...
    await sequelize.transaction(async (t) => {
        ...
        req.application.notification_email = await core.fetchUser(req.body, req.headers['x-auth-token']);

        // Sending the mail to a user.
        await mailer.sendMail({
            to: req.application.notification_email,
